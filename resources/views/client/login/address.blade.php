        ...
        <div class="container">
            <div class="d-flex flex-column flex-md-row justify-content-between">
                <div class="col-md-3 col-12">
                    <div class="nav flex-column nav-pills me-3 border inside_sidebar" id="v-pills-tab" role="tablist"
                        aria-orientation="vertical">
                        <button class="nav-link border-bottom text-secondary py-3 text-start active" id="v-pills-Orders-tab"
                        ...
                        <button class="nav-link border-bottom text-secondary py-3 text-start" id="v-pills-Addresses-tab"
                            data-bs-toggle="pill" data-bs-target="#v-pills-Addresses" type="button" role="tab"
                            aria-controls="v-pills-Addresses" aria-selected="false">
                            <i class="fa-solid fa-pen-to-square mx-1"></i>@lang('trans.addresses')
                        </button>
                        <button class="nav-link border-bottom text-secondary py-3 text-start" id="v-pills-Account-tab"
                        ...
                        <a href="{{ route('Client.logout') }}"
                            class="nav-link border-bottom text-secondary py-3 text-start cursor-pointer">
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-Orders" role="tabpanel"
                            ...
                            @forelse($Orders as $Order)
                                <div class="alert alert-primary blue-alert d-flex justify-content-between rounded-0"
                                    role="alert">
                                    <span> #{{ $Order->id }} - {{ $Order->created_at->format('Y-m-d') }} -
                                        @lang('trans.net_total'):
                                        {{ format_number($Order->net_total * Country()->currancy_value) }}</span>
                                    <span>
                                        <a class="text-white text-decoration-none" data-bs-toggle="modal"
                                            data-bs-target="#order-{{ $Order['id'] }}"
                                            href="#">@lang('trans.details')</a>
                                    </span>
                                </div>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="order-{{ $Order['id'] }}Label">
                                                    @lang('trans.orderDetails')</h5>
                                                <button type="button" class="close" data-bs-dismiss="modal"
                                                    aria-label="Close" style="display:contents">
                                                ...
                                                <table class="table table-striped table-hover text-center">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">{{ $Order->created_at->format('Y-m-d') }}
                                                            </td>
                                                            <td colspan="2">
                                                                {{ format_number($Order->net_total * Country()->currancy_value) . ' ' . Country()->currancy_code }}
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="4">
                                                                {{ $Order->Client ? $Order->Client->name : $Order->address->first_name . $Order->address->last_name }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th colspan="4">{{ __('trans.email') }}</th>
                                                            <td colspan="4">
                                                                {{ $Order->Client ? $Order->Client->email : $Order->address->email }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th colspan="4">{{ __('trans.phone') }}</th>
                                                            <td colspan="4">
                                                                {{ $Order->Client ? $Order->Client->phone_code . $Order->Client->phone : $Order->address->phone }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="8">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="4">
                                                                {{ format_number($Order->sub_total * Country()->currancy_value) . ' ' . Country()->currancy_code }}
                                                            </td>
                                                        </tr>
                                                        @if ($Order->charge_cost > 0)
                                                            <tr>
                                                                ...
                                                                <td colspan="4">
                                                                    {{ format_number($Order->charge_cost * Country()->currancy_value) . ' ' . Country()->currancy_code }}
                                                                </td>
                                                            </tr>
                                                        @endif
                                                        @if ($Order->discount > 0)
                                                            <tr>
                                                                ...
                                                                <td colspan="4">
                                                                    {{ format_number($Order->discount * Country()->currancy_value) . ' ' . Country()->currancy_code }}
                                                                </td>
                                                            </tr>
                                                        @endif
                                                        <tr>
                                                            ...
                                                            <td colspan="4">
                                                                {{ format_number($Order->vat * Country()->currancy_value) . ' ' . Country()->currancy_code }}
                                                            </td>
                                                        </tr>
                                                        @if ($Order->coupon > 0)
                                                            <tr>
                                                                <th colspan="4">{{ __('trans.coupon') }}
                                                                    ({{ $Order->coupon_text }})</th>
                                                                <td colspan="4">
                                                                    {{ format_number($Order->coupon * Country()->currancy_value) . ' ' . Country()->currancy_code }}
                                                                </td>
                                                            </tr>
                                                        @endif
                                                        <tr>
                                                        ...
                                                        @if ($Order->address)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="4">{{ $Order->address->country->title() }}
                                                                </td>
                                                            </tr>
                                                            ...
                                                            @if ($Order->address->country_id == 1)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="4">{{ $Order->address->building_no }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th colspan="4">{{ __('trans.floor_no') }}</th>
                                                                    <td colspan="4">{{ $Order->address->floor_no }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th colspan="4">{{ __('trans.apartment') }}</th>
                                                                    <td colspan="4">{{ $Order->address->apartment }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th colspan="4">{{ __('trans.apartmentType') }}
                                                                    </th>
                                                                    <td colspan="4">
                                                                        {{ $Order->address->apartmentType }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th colspan="4">
                                                                        {{ __('trans.additional_directions') }}</th>
                                                                    <td colspan="4">
                                                                        {{ $Order->address->additional_directions }}</td>
                                                                </tr>
                                                            @else
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="4">{{ $Order->address->address1 }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th colspan="4">{{ __('trans.address2') }}</th>
                                                                    <td colspan="4">{{ $Order->address->address2 }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="4">{{ $Order->address->gift_comment }}
                                                                </td>
                                                            </tr>
                                                        @else
                                                            <tr>
                                                    ...
                                                    <tbody>
                                                        @foreach ($Order->Products as $item)
                                                            <tr>
                                                                ...
                                                                <td>{{ format_number($item->price * Country()->currancy_value) . ' ' . Country()->currancy_code }}
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                ...
                                <div class="alert alert-primary blue-alert d-flex justify-content-between rounded-0"
                                    ...
                                    <div class="">
                                        <a href="{{ route('Client.shop') }}"
                                            class="btn btn-light rounded-1 py-1 fs-7">@lang('trans.browse_products')</a>
                                    </div>
                                </div>
                            @endforelse
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="card mt-5 bg-white rounded-0">
                                            <div class="card-body">
                                                <form action="{{ route('Client.updateShippingAddress') }}"
                                                    method="post">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-sm-6 mb-3">
                                                            <label for=""
                                                                class="text-secondary">@lang('trans.first_name') <span
                                                                    class="red-label">*</span>
                                                            </label>
                                                            <input type="text" class="form-control rounded-0"
                                                                name="first_name" id=""
                                                                value="{{ old('first_name_shipping', addressShipping() ? addressShipping()->first_name : '') }}"
                                                                required
                                                        ...
                                                        <div class="col-sm-6 mb-3">
                                                            <label for=""
                                                                class="text-secondary">@lang('trans.last_name') <span
                                                                    class="red-label">*</span>
                                                            </label>
                                                            <input type="text" class="form-control rounded-0"
                                                                name="last_name" id=""
                                                                value="{{ old('last_name_shipping', addressShipping() ? addressShipping()->last_name : '') }}"
                                                                required
                                                                oninvalid="this.setCustomValidity(@lang('trans.this_field_required'))"
                                                                title="@lang('trans.this_field_required')">
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12 mb-3">
                                                            <label for=""
                                                                class="text-secondary">@lang('trans.country')<span
                                                                    class="red-label">*</span>
                                                            </label>
                                                            <select class="rounded-0 form-select" name="country_id"
                                                                ...
                                                                @foreach (Countries() as $country)
                                                                    <option value="{{ $country->id }}"
                                                                        {{ old('country_id', addressShipping() ? addressShipping()->country_id : '') == $country->id ? 'selected' : '' }}>
                                                                        {{ $country['title_' . lang()] }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>

                                                        <div id="otherCountries" class="row"
                                                            style="{{ addressShipping()?->country_id !== '1' ? 'display:block' : 'display:none' }}">
                                                            <div class="col-sm-12 mb-3">
                                                                <label for=""
                                                                    class="text-secondary">@lang('trans.city') <span
                                                                        class="red-label">*</span>
                                                                </label>
                                                                <input type="text" class="form-control rounded-0"
                                                                    name="city" id=""
                                                                    value="{{ addressShipping() ? addressShipping()->city : old('city', '') }}"
                                                                    required
                                                                    oninvalid="this.setCustomValidity(@lang('trans.this_field_required'))"
                                                                    title="@lang('trans.this_field_required')">
                                                            </div>
                                                            <div class="col-sm-12 mb-3">
                                                                <label for=""
                                                                    class="text-secondary">@lang('trans.state')
                                                                    (@lang('trans.optional'))
                                                                </label>
                                                                <input type="text" class="form-control rounded-0"
                                                                    name="state" id=""
                                                                    value="{{ addressShipping() ? addressShipping()->state : old('state', '') }}">
                                                            </div>
                                                            <div class="col-sm-12 mb-3">
                                                                <label for=""
                                                                    class="text-secondary">@lang('trans.street_address') <span
                                                                        class="red-label">*</span>
                                                                </label>
                                                                <input type="text" class="form-control rounded-0 mb-3"
                                                                    name="address1" id=""
                                                                    placeholder="@lang('trans.address1')"
                                                                    value="{{ old('address1', addressShipping() ? addressShipping()->address1 : '') }}"
                                                                    required
                                                                    oninvalid="this.setCustomValidity(@lang('trans.this_field_required'))"
                                                                    title="@lang('trans.this_field_required')">
                                                                <input type="text" class="form-control rounded-0"
                                                                    name="address2" id=""
                                                                    placeholder="@lang('trans.address2')"
                                                                    value="{{ old('address1', addressShipping() ? addressShipping()->address2 : '') }}">
                                                            </div>
                                                        </div>

                                                        <div id="bahrain" class="row"
                                                            style="{{ addressShipping()?->country_id == '1' ? 'display:none' : 'display:block' }}">
                                                            <div class="col-sm-12 col-md-6 mb-3">
                                                                <label for=""
                                                                    class="text-secondary">@lang('trans.region')
                                                                </label>
                                                                <select class="rounded-0 form-select" name="region_id"
                                                                    id="region_id" required
                                                                    oninvalid="this.setCustomValidity(@lang('trans.this_field_required'))"
                                                                    title="@lang('trans.this_field_required')">
                                                                    <option value="">@lang('trans.select_region')</option>
                                                                    {{--                                      <option value="{{ old('region_id', addressShipping() ? (addressShipping()->region_id ?? '') : '') }}" selected>{{addressShipping() ? addressShipping()->region_id['title_'.lang()] : ''}}</option> --}}
                                                                    <option
                                                                        value="{{ old('region_id', addressShipping() ? addressShipping()->region_id ?? '' : '') }}"
                                                                        selected>
                                                                        {{ addressShipping() ? (addressShipping()->region_id ? addressShipping()->region['title_' . lang()] : '') : '' }}
                                                                    </option>
                                                                </select>
                                                            </div>
                                                            <div class="col-sm-12 col-md-6 mb-3">
                                                                <label for=""
                                                                    class="text-secondary">@lang('trans.block')
                                                                </label>
                                                                <input type="text" class="form-control rounded-0"
                                                                    name="block"
                                                                    value="{{ addressShipping() ? addressShipping()->block : old('block', '') }}"
                                                                    required
                                                                    oninvalid="this.setCustomValidity(@lang('trans.this_field_required'))"
                                                                    title="@lang('trans.this_field_required')">
                                                            </div>
                                                            <div class="col-sm-12 col-md-6 mb-3">
                                                                <label for=""
                                                                    class="text-secondary">@lang('trans.road')
                                                                </label>
                                                                <input type="text" class="form-control rounded-0"
                                                                    name="road"
                                                                    value="{{ addressShipping() ? addressShipping()->road : old('road', '') }}"
                                                                    required
                                                                    oninvalid="this.setCustomValidity(@lang('trans.this_field_required'))"
                                                                    title="@lang('trans.this_field_required')">
                                                            </div>
                                                            <div class="col-sm-12 col-md-6 mb-3">
                                                                <label for=""
                                                                    class="text-secondary">@lang('trans.building_no')
                                                                </label>
                                                                <input type="text" class="form-control rounded-0"
                                                                    name="building_no"
                                                                    value="{{ addressShipping() ? addressShipping()->building_no : old('building_no', '') }}"
                                                                    required
                                                                    oninvalid="this.setCustomValidity(@lang('trans.this_field_required'))"
                                                                    title="@lang('trans.this_field_required')">
                                                            </div>
                                                            <div class="col-sm-12 col-md-6 mb-3">
                                                                <label for=""
                                                                    class="text-secondary">@lang('trans.floor_no')
                                                                </label>
                                                                <input type="text" class="form-control rounded-0"
                                                                    name="floor_no"
                                                                    value="{{ addressShipping() ? addressShipping()->floor_no : old('floor_no', '') }}"
                                                                    required
                                                                    oninvalid="this.setCustomValidity(@lang('trans.this_field_required'))"
                                                                    title="@lang('trans.this_field_required')">
                                                            </div>
                                                            <div class="col-sm-12 col-md-6 mb-3">
                                                                <label for=""
                                                                    class="text-secondary">@lang('trans.apartment')
                                                                </label>
                                                                <input type="text" class="form-control rounded-0"
                                                                    name="apartment"
                                                                    value="{{ addressShipping() ? addressShipping()->apartment : old('apartment', '') }}"
                                                                    required
                                                                    oninvalid="this.setCustomValidity(@lang('trans.this_field_required'))"
                                                                    title="@lang('trans.this_field_required')">
                                                            </div>
                                                            <div class="col-sm-12 col-md-6 mb-3">
                                                                <label for=""
                                                                    class="text-secondary">@lang('trans.apartmentType')
                                                                </label>
                                                                <input type="text" class="form-control rounded-0"
                                                                    name="apartmentType"
                                                                    value="{{ addressShipping() ? addressShipping()->apartmentType : old('apartmentType', '') }}"
                                                                    required
                                                                    oninvalid="this.setCustomValidity(@lang('trans.this_field_required'))"
                                                                    title="@lang('trans.this_field_required')">
                                                            </div>
                                                            <div class="col-sm-12 col-md-6 mb-3">
                                                                <label for=""
                                                                    class="text-secondary">@lang('trans.additional_directions')
                                                                </label>
                                                                <input type="text" class="form-control rounded-0"
                                                                    name="additional_directions"
                                                                    value="{{ addressShipping() ? addressShipping()->additional_directions : old('additional_directions', '') }}">
                                                            </div>
                                                        </div>

                                                        <div class="col-4">
                                                            <button type="submit"
                                                                class="btn btn-info rounded-0 px-3">@lang('trans.save_changes')</button>
                                                        </div>
                                    ...
                                    <div class="card bg-white rounded-0 p-4">
                                        <div class="card-body">
                                            <form action="{{ route('Client.updateAccountDetails') }}" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 mb-3">
                                                        <label for="" class="text-secondary">@lang('trans.name')
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <label for=""
                                                            class="text-secondary">@lang('trans.email')<span
                                                                class="red-label">*</span>
                                                        </label>
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <label for="" class="text-secondary">@lang('trans.current_password')
                                                            (@lang('trans.leave_blank_to_leave_unchanged'))
                                                        </label>
                                                        <input type="password" class="form-control rounded-0"
                                                            name="current_password" placeholder="" id="current-password">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        ...
                                                        <input type="password" class="form-control rounded-0"
                                                            name="password" placeholder="" id="current-password">
                                                        <i class="toggle-password fa fa-fw fa-eye mx-3"></i>
                                                        @error('password')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            togglePasswords.forEach(function(icon) {
                icon.addEventListener('click', function() {
                    ...
                    'input[type="password"]'); // Get the password input within the same parent element
