                ...
                <div class="h-100 w-100 d-flex justify-content-center align-items-center">
                    <form action="{{ route('Client.login') }}" class=" w-75 py-5" method="POST">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="hidden" name="country_code" id="country_code_2" value="{{ old('register_phone_code', Country()->phone_code ) }}"/>
                        </div>
            ...
            <div class="col-lg-6 col-12" id="RegisterPage" hidden>
                <div class="h-100 w-100 d-flex justify-content-center align-items-center">
                    ...
                    <form action="{{ route('Client.register') }}" class="w-75" method="POST">
                        @csrf
                        <div class="row">
                            <h6 class="text-secondary">WELCOME HERE</h6>
                            <h4 class=" py-3 mb-0 fw-bold header-div d-flex gap-2 align-items-center">Create New Account
                            </h4>
                            <div class="mb-3 d-flex text-secondary fw-semibold">
                                <span>Already have an account?</span>
                                <span class="px-2"><a class="text-black text-decoration-none GoToLogInPageButton"
                                        id="LoginAccount">Login</a></span>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="hidden" name="country_code" id="country_code_1" value="{{ old('country_code', Country()->country_code ) }}"/>
                            </div>
                            ...
                            <div class="col-12">
                                <button class="btn-dark btn text-white px-5 py-2 mb-3 w-100 " type="submit"> Create an
                                    account </button>
            ...
            <div class="col-lg-6 col-12" id="ForgetPassword" hidden>
                <div class="h-100 w-100 d-flex justify-content-center align-items-center">
                    ...
                    <form action="{{ route('Client.forget') }}" method="POST" class="send-mail w-75">
                        @csrf
                        <div class="row">
                            <h6 class="text-secondary">FIRST STEP/3</h6>
                            <h4 class=" py-3 mb-0 header-div fw-bold d-flex gap-2 align-items-center">Forget Password</h4>
