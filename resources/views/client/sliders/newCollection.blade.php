<div class="container my-5" data-aos="fade-up">
    <div class="row">
        <div class="col-12 d-flex justify-content-center align-items-center">
            <h3 class="py-4 fw-semibold">@lang('trans.new_collection')</h3>
        </div>
    </div>
...
{{-- <div class=" p-2 ">
                <div class="card  border-0 rounded-0  position-relative p-2">
                    <div class="position-absolute best-sell p-2">
                        <div
                            class="rounded-pill bg-warning  text-white d-flex px-3 py-1 align-items-center gap-1  fw-semibold">
                            <span><img src="assets/imgs/home/Stroke 1.png" /></span>
                        ...
                        <div class="card-text my-2">
                            <div class="d-flex gap-2 flex-wrap">
                                <div class="color " style="border-color: #0C0C0C !important;"
                                    ...
                                    <div class="border-white  border-2 w-100 h-100">
                                        <div class="w-100 h-100 rounded-circle" style="background-color: #0C0C0C;">
                                        </div>
                                    </div>
                                </div>
                                <div class="color active" style="border-color: #172B85 !important;"
                                    ...
                                    <div class="border-white  border-2 w-100 h-100">
                                        <div class="w-100 h-100 rounded-circle" style="background-color: #172B85;">
                                        </div>
                                    </div>
                                </div>
                                <div class="color " style="border-color: #CE1126 !important;"
                                    ...
                                    <div class="border-white  border-2 w-100 h-100">
                                        <div class="w-100 h-100 rounded-circle" style="background-color: #CE1126;">
                                        </div>
                                    </div>
                                </div>
                                <div class="color " style="border-color: #F9A000 !important;"
                                    ...
                                    <div class="border-white  border-2 w-100 h-100">
                                        <div class="w-100 h-100 rounded-circle" style="background-color: #F9A000;">
                                        </div>
                                    </div>
                                </div>
                                <div class="color " style="border-color: #00ffd5 !important;"
                                    ...
                                    <div class="border-white  border-2 w-100 h-100">
                                        <div class="w-100 h-100 rounded-circle" style="background-color: #00ffd5;">
                                        </div>
                                    </div>
                                </div>
                            </div>
