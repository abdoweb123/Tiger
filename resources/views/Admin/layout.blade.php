...
<head>
    ...
    <style>
       /* to remove checkEditor warning notifications */
        .cke_notifications_area, .tox-notification{
            display: none;
        }
        :root {
                ...
                @else
                    <li class="nav-item">
                        <a href="{{ route('lang', 'en') }}">
                            <span class="icon text-center">
                                <img src="{{ asset('language/en.png') }}" style="border-radius: 50%;width: 20px;"
                                    class="mx-2">
                            </span>
                        ...
                        <div class="header-right">
                            <div class="profile-box ml-15">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                                    <li>
                                        <a href="{{ route('admin.profile.show') }}"> <i class="lni lni-user"></i>
                                            {{ __('trans.myProfile') }}</a>
                                    </li>
                                    <li>
            ...
            <div class="container-fluid">
                <div class="title-wrapper pt-30 d-flex" style="justify-content: space-between;">
                    ...
                    @hasSection('back')
                        <div class="title mb-30">
                            <a href="@yield('back')"><i
                                    class="fa-solid fa-arrow-{{ lang('ar') ? 'left' : 'right' }}-long h1"></i></a>
                        </div>
                    @endif
                </div>
