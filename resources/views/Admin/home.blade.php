...
@section('css')
    <style>
        ...
        .bars {
            ...
            font-size: 12px;
            font-weight: 600;
            /background: #555;/ background-image: url('./include/squares.jpg');
            ...
            height: 370px;
            width: 100%;
            /overflow-x: auto;/ box-shadow: 0 0 10px 0 #555;
            border-radius: 5px;
        }
                                    ...
                                    <div class="mb-4 box-shadow text-center border">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-4">
                                                    <h4 class="card-title pricing-card-title mt-2">{{ $categoriesCount }}
                                                    </h4>
                                                </div>
                                            </div>
                                    ...
                                    <div class="mb-4 box-shadow text-center border">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-4">
                                                    <h4 class="card-title pricing-card-title mt-2">{{ $subscribersCount }}
                                                    </h4>
                                                </div>
                                            </div>
                                    ...
                                    <div class="mb-4 box-shadow text-center border">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-4">
                                                    <h4 class="card-title pricing-card-title mt-2">
                                                        {{ $currentOrdersCount }}</h4>
                                                </div>
                                            </div>
